...
import AddPOIModal, { type POIFormData } from '../../components/modals/AddPOIModal';
import EditPOIModal from '../../components/modals/EditPOIModal';
...
const CityDetailsPage: React.FC = () => {
    ...
    const loadCityData = useCallback(async () => {
        ...
        try {
            ...
            const cityResponse = await citiesAPI.getById(parseInt(id));
            setCity(cityResponse as City);

            // Charger les POIs de cette ville
            const poisResponse = await poisAPI.getByCity(parseInt(id));
        ...
        <div className="bg-gray-50 min-h-screen p-6">
            ...
            <div className="mb-6">
                ...
                <p className="text-gray-600 text-sm">
                    Manage city information and associated Points of Interest (POIs).
                </p>
            </div>
